...
# Title: Dvbs Tx
# Generated: Tue Jan 15 11:48:50 2019
##################################################
...
class dvbs_tx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.pluto_sink_0 = iio.pluto_sink('', frequency, samp_rate, 20000000, 0x8000, False, 10.0, '', True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/media/" + username + "/PlutoSDR/rpidatv.ts", True)
    ...
    def set_username(self, username):
        ...
        self.blocks_file_source_0.open("/media/" + self.username + "/PlutoSDR/rpidatv.ts", True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.pluto_sink_0.set_params(self.frequency, self.samp_rate, 20000000, 10.0, '', True)
