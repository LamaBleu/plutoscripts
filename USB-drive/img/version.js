...
function CheckFrmVersion() {
	...
	req.done(function(response) {
		...
		var res = versionCompare("v0.29-1-g2e94-dirty", VerOnGithub);
		if (res < 0) {
			var message = "Newer version available online (Version " + VerOnGithub + " )";
			document.getElementById('versionsection').className = "download";
		} else  if (res > 0) {
			var message = "Wow! Your Pluto Firmware Version v0.29-1-g2e94-dirty is newer than (" + VerOnGithub + ") on Github.";
