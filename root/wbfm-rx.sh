...
rx_sdr -F CF32 -s 3000000 -f ${1}M -g $2 - | csdr fir_decimate_cc 12 0.06 HAMMING | csdr fmdemod_quadri_cf | csdr fractional_decimator_ff 5  | csdr deemphasis_wfm_ff 48000 60e-6 | csdr convert_f_i16 | nmux -a #IP# -p 4444
